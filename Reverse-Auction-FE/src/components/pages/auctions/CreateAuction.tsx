    ...
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-4 space-y-8 sticky top-24">
          <div>
            <h1 className="text-4xl font-bold text-slate-900 mb-4 leading-tight">Tạo yêu cầu<br/>đấu giá</h1>
            <p className="text-slate-600 text-lg">
              Mô tả chi tiết linh kiện bạn cần để nhận báo giá cạnh tranh nhất từ hàng trăm người bán uy tín.
            </p>
          </div>

          <div className="bg-slate-100/70 rounded-3xl p-8 space-y-6">
            <h3 className="font-bold text-slate-800 text-lg">Tại sao nên tạo đấu giá?</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold text-slate-800">Miễn phí hoàn toàn</h4>
                <p className="text-slate-500 text-sm mt-1">Người mua không phải trả bất kỳ khoản phí niêm yết nào.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold text-slate-800">Bảo vệ thanh toán</h4>
                <p className="text-slate-500 text-sm mt-1">Tiền của bạn được giữ an toàn cho đến khi nhận và kiểm tra hàng.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold text-slate-800">Nhận báo giá nhanh</h4>
                <p className="text-slate-500 text-sm mt-1">Hệ thống thông báo tức thì đến người bán phù hợp.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-8 bg-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 sm:p-12">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Ngân sách dự kiến *</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Thời hạn kết thúc *</label>
                <input
                  type="datetime-local"
                  name="endDate"
                  required
            ...
            {/* Row 4: Image Upload */}
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">Hình ảnh tham khảo</label>
              <div 
              ...
              >
                ...
                <p className="font-semibold text-slate-700">Kéo thả ảnh vào đây hoặc nhấn để chọn</p>
                <p className="text-sm text-slate-500 mt-1">Hỗ trợ JPG, PNG (Tối đa 5MB/ảnh)</p>
              </div>
              ...
              {previewImages.length > 0 && (
                <div className="flex gap-4 mt-4 overflow-x-auto pb-2">
                  {previewImages.map((src, index) => (
                    <div key={index} className="relative w-24 h-24 rounded-xl border border-slate-200 overflow-hidden flex-shrink-0 group">
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-2 text-slate-600">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-50 text-blue-600 text-xs font-bold">i</span>
                Phí niêm yết: <strong className="text-slate-900">Miễn phí cho người mua</strong>
              </div>
