            ...
            <div className="grid grid-cols-3 gap-2">
                {BANKS.map((bank) => (
                    ...
                    >
                        ...
                        {selectedBank === bank.code && (
                            <div
                                className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-[#375F97] flex items-center justify-center">
...
export function CheckoutPage() {
    ...
    const [paymentMethod, setPaymentMethod] = useState<"vnpay" | "balance" | "cod">("balance");
    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            ...
            if (paymentMethod === "balance") {
                ...
                await orderService.paySessionWithBalance(session.sessionId);
                        ...
                        <div className="space-y-4">
                            {groupedShops.length === 0 ? (
                                <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-8 text-center">
                                    <div
                                        className="w-16 h-16 mx-auto mb-3 rounded-full bg-slate-100 flex items-center justify-center">
