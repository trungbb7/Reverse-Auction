...
import vn.edu.hcmuaf.reverseauction.repository.complaint.ComplaintRepository;
...
public class ComplaintService {
    ...
    public CreateComplaintResponse createComplaint(CreateComplaintRequest request) {
        ...
        complaint.setOrderId(request.orderId());
        ...
        return new CreateComplaintResponse(complaint.getId(), complaint.getOrderId(), complaint.getStatus(), complaint.getCreatedAt());
    }
    ...
    private ComplaintResponse toComplaintSummary(ComplaintEntity complaint) {
