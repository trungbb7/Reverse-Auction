...
public class PaymentUtils {
    ...
    public String buildPaymentUrl(Long amount_p, String bankCode) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        vnp_Params.put("vnp_ReturnUrl", "http://localhost:5173/demo");
